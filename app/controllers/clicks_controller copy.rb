class ClicksController < ApplicationController
  ...
  def create
    ...
    @click = Click.new(:actualurl => 'not set', :device => device, :targeturl => 'fb233936543368280://', :defaulturl => 'https://itunes.apple.com/us/app/gametime-future-digital-access/id630687854?ls=1&mt=8', :client => params[:client], :ref => params[:ref])
