...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { CountryCode: @recipient.CountryCode, OptOut: @recipient.OptOut, Phone: @recipient.Phone }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { CountryCode: @recipient.CountryCode, OptOut: @recipient.OptOut, Phone: @recipient.Phone }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
